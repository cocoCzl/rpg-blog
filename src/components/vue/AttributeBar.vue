  ...
  <div class="mb-2">
    <div class="flex justify-between items-center mb-1">
      ...
      <div class="flex items-center gap-2">
        ...
        <span class="text-[0.5rem] font-mono" :class="value < 30 ? 'text-red-400' : ''">{{ value }} / {{ max }}</span>
      </div>
    </div>
    <div class="h-2.5 rounded-full overflow-hidden relative" style="background: rgba(255,255,255,0.08)" role="progressbar" :aria-valuenow="value" :aria-valuemin="0" :aria-valuemax="max" :aria-label="realLabel" :aria-valuetext="`${value} out of ${max}`">
